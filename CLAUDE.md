...
Vault/View/settings/UI code in the plugin. The current synchronized release is `0.5.4`; use the
mirror sync/check scripts and `MIRROR.json` for the version, Git-SHA, and Core-hash contract. The
current synchronized release is `0.5.6`.
